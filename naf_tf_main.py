...
def setup_flags(use_batch_norm=None, learning_rate=None, noise_scale=None, env_name=None, nbatch_standard=None):
    flags = tf.app.flags
    ...
    flags.DEFINE_integer('batch_size', nbatch_standard, 'The size of batch for minibatch training')
    ...
    flags.DEFINE_integer('max_episodes', 2, 'maximum # of episodes to train')
...
def learn_setup(use_batch_norm=None, learning_rate=None, noise_scale=None, env_name =None, env=None, nbatch_standard=None):
  conf, logger = setup_flags(use_batch_norm=use_batch_norm, learning_rate=learning_rate, noise_scale=noise_scale, env_name=env_name, nbatch_standard = nbatch_standard)
